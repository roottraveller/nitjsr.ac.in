<?php 
$page='main notice board notifications';
...
<hr width="2px"  color="#000000"/>
 <table class="data_fech" cellspacing="10px" cellpadding="10px">   
          <?php
		   $result=mysql_query("select * from notifications where main='1' and status='1' order by time DESC");
	...
	<?php echo "<a href='results1.php?no=$id' onClick=\"return confirm('Are You Sure You Want to unpublish this Notification ??')\">Unpublish</a>"; ?>
			</td>
      				</tr>
