...
$result = mysql_query("SELECT * FROM tabs WHERE sno = '$no'");
...
if (!$result) 
		...
		die("Error: Data not found..");
				...
				$events=$test['events'] ;
				$news=$test['news'] ;
				$important links=$test['important_links'] ;
				$description=$test['description'] ;
				$time=$test['time'] ;
				//$exdate=$test['expiry_date'];
?>
<form method="post" action="succtab.php?no=<?php echo $no;?>"  enctype="multipart/form-data">
<center>
