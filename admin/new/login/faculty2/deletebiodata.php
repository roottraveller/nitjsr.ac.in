...
<?php
$sql=sprintf("update user set biodata=NULL where uid='%s'", 
    		mysql_real_escape_string($id));
			$result=mysql_query($sql);
			if($result){ echo 'Biodata Deleted Successfully.</br>' ?>
			<form id="basic" method="post" action="index.php?id=<?php echo $id;?>">
 <input name="delete" type="submit" id="delete" value="OK" style="margin-top:10px;">
</form><?php }
