...
<a href="<?php echo $root;?>department/index.php?dept=chemistry&page=home" class="deptboxl"><div class="deptimg"  ><img src="<?php echo $root;?>dimages/chem.jpeg" alt="" height="90px" width="100px"></img></div></br>Chemistry</a>
	...
	<a href="<?php echo $root;?>department/index.php?dept=humanities&page=home" class="deptboxl"><div class="deptimg"><img src="<?php echo $root;?>dimages/hum.jpeg" alt="" height="90px" width="100px"></img></div></br>Humanitites</a>
